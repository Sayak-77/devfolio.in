        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              A B.Tech graduate with hands-on experience in Java development and
              a strong passion for backend engineering. Skilled in building
              scalable, efficient, and maintainable server-side applications. I
              enjoy solving complex problems, and working with databases, APIs,
              and system architecture. Always eager to learn new technologies
              and contribute to impactful backend solutions.
            </p>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a
                href="/Sayak_Chatterjee_CV.pdf"
                download="Sayak_Chatterjee_CV.pdf"
